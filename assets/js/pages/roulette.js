document.addEventListener('DOMContentLoaded', function() {
    ...
    const rouletteConfig = {
        ...
        specialPrize: {
            name: "Special Prize",
            image: "../assets/images/roulette/special.webp",
            nation: "Mystery",
            type: "Legendary",
            slug: "special-prize",
            ...
            almostSound: "../assets/sounds/fail.wav"
        }
    };
    ...
    const clickSound = new Audio('../assets/sounds/click_2.wav');
    ...
    function createRouletteItems(tankData) {
        ...
        duplicatedTanks.forEach((tank, index) => {
            ...
            item.innerHTML = `
                <img src="${tank.image}" alt="${tank.name}" onerror="this.src='../assets/images/placeholder/imagefailedtoload.webp'">
                <h4>${tank.name}</h4>
            `;
